...
export class NodemailerService {
    contentMail(userName: string, text: string) {
        ...
        return `
        <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2;background-color: #37354F;color: white;">
        <div style="margin:50px auto;width:70%;padding:20px 0 bac;">
          ...
          <div style="padding: 10px;">
            ...
            ${text}
            <p style="font-size:0.9em;">Trân trọng,<br />UME</p>
          </div>
       
          <hr style="border:none;border-top:1px solid #eee" />
          <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
            <p>UME Inc</p>
            <p>Phone: (+84) 947 875 3625</p>
            <p>⬜ Gmail: chudtmse150303@fpt.edu.vn </p>
          </div>
        </div>
      </div>`;
    }
